...
Candidate directions carried forward from `PROJECT.md`: distribution readiness, launch-at-login convenience, troubleshooting/diagnostics surface, broader player support, and optional stronger power/security evidence.
