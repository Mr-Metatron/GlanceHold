...
- [ ] 04-06-PLAN.md — Push-first IINA plugin status stream, Swift subscription handling, and low-frequency fallback.
...
| 4. IINA Adapter Spike and End-to-End Playback Control | 5/6 | In Progress|  |
